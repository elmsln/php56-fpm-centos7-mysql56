...
yum install -y --enablerepo=remi-php56 php php-apcu php-fpm php-opcache php-cli php-yaml php-ldap php-common php-gd php-mbstring php-mcrypt php-pdo php-xml php-mysqlnd
